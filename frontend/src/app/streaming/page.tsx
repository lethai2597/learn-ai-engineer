          ...
          <div className="px-6 py-4 space-y-4">
            <div className="space-y-3 bg-gray-50 p-4 rounded-lg border border-gray-200">
              ...
              <div>
                ...
                <Paragraph className="text-gray-700 leading-relaxed mb-0 text-sm">
                  Streaming cho phép hiển thị response từng token ngay khi LLM generate, cải thiện perceived performance đáng kể.
                </Paragraph>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-1 text-gray-700 text-sm">
                  <li>Token-by-token Streaming và SSE implementation</li>
                  <li>WebSocket khi nào cần thay vì SSE</li>
                  <li>Cancellation & Error Handling</li>
                </ul>
              </div>
            </div>
