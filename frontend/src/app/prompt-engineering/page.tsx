          ...
          <div className="px-6 py-4 space-y-8">
            <div className="space-y-3 bg-gray-50 p-4 rounded-lg border border-gray-200">
              ...
              <div>
                ...
                <Paragraph className="text-gray-700 leading-relaxed mb-0 text-sm">
                  Prompt Engineering là kỹ thuật quan trọng nhất khi làm việc với LLM. Thay vì train lại model, bạn có thể hướng dẫn AI thông qua prompt để đạt được kết quả mong muốn.
                </Paragraph>
              </div>
              ...
              <div>
                ...
                <ul className="list-disc list-inside space-y-1 text-gray-700 text-sm">
                  <li>Zero-shot và Few-shot Prompting</li>
